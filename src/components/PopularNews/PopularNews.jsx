        ...
        <div className='relative py-[60px] px-[15px] overflow-hidden bg-white'>
            <div className='max-w-[1170px] max-1200:max-w-[970px] max-992:max-w-[750px] w-full mx-auto'>
                ...
                <div className='mt-[30px] relative w-full'>
                    ...
                    <div className='max-768:hidden swiper-prev-btn absolute left-[-2%] size-[38px] top-1/2 bg-white z-[10] rounded-full text-black text-center cursor-pointer flex items-center justify-center shadow-[0_3px_10px_rgb(0,0,0,0.2)] -translate-y-1/2'><FiChevronLeft className='text-xl mr-[2px]'/></div>
                    <div className='max-768:hidden swiper-next-btn absolute right-[-2%] size-[38px] top-1/2 bg-white z-[10] rounded-full text-black text-center cursor-pointer flex items-center justify-center shadow-[0_3px_10px_rgb(0,0,0,0.2)] -translate-y-1/2'><FiChevronRight className='text-xl'/></div>
                </div>
            </div>
        </div>
    )
