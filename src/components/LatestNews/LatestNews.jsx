        ...
        <div className='px-4'>
            <div className='max-w-[1170px] max-1200:max-w-[970px] max-992:max-w-[750px] w-full mx-auto pt-4 pb-[60px]'>
                <div className='w-full flex justify-between items-center border-b pb-2 relative'>
                    <div className='after:absolute after:border-b-[6px] after:rounded-sm after:right-0 after:left-0 
                                    after:bottom-[-3px] after:w-[145px] after:max-768:w-[135px] after:border-yellow-400 
                                    after:max-768:border-b-[3px] after:max-768:bottom-[-2px]
                '>
                ...
                <div className='mt-8'>
                    <div className='grid grid-cols-4 gap-6 max-768:grid-cols-2 max-768:gap-3'>
                        {latestNewsData?.slice(0, refetchNews)?.map((news, index) =>  (
                            <a href='#' className={`${news.newsDesc !== '' ? 'row-span-2 col-span-2' : ''} border border-[#f3f3f3] rounded-md overflow-hidden hover:translate-y-[-5px] duration-300`} key={index}>
                                <div>
                    ...
                    <div  className='hidden max-768:block w-full mt-6 mb-3'>
                        <div className='flex justify-center items-center'>
                            <button className='bg-gradient-to-r w-[190px] from-amber-500 to-yellow-400 text-white py-2 px-[30px] text-lg rounded font-semibol'>ดูทั้งหมด</button>
                        </div>
                    </div>
                </div>
            </div>
